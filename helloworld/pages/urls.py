...
from .views import CartView, HomePageView, AboutPageView, ImageViewFactory, ImageViewNoDI, ProductIndexView, ProductShowView, ProductCreateView, ContactPageView, CartRemoveAllView
